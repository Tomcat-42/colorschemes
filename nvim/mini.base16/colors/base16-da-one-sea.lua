return {
  {
    ...
    config = function()
      require("mini.base16").setup({
        palette = {
          base00 = '#22273d', -- Default Background
      ...
      vim.api.nvim_set_hl(0, 'VertSplit', { fg = "#374059", bg = nil, attr = nil, sp = nil })
      vim.api.nvim_set_hl(0, 'WinSeparator', { fg = "#374059", bg = nil, attr = nil, sp = nil })
    end
  }
}
