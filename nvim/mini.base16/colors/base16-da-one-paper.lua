return {
  {
    ...
    config = function()
      require("mini.base16").setup({
        palette = {
          base00 = '#faf0dc', -- Default Background
      ...
      vim.api.nvim_set_hl(0, 'VertSplit', { fg = "#c8c8c8", bg = nil, attr = nil, sp = nil })
      vim.api.nvim_set_hl(0, 'WinSeparator', { fg = "#c8c8c8", bg = nil, attr = nil, sp = nil })
    end
  }
}
